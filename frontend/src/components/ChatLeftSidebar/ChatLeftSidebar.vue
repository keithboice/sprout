...
import ChatContact        from "@/components/ChatContact/ChatContact.vue"
import UserProfileSidebar from "@/components/UserProfileSidebar/UserProfileSidebar.vue"

/**
 * Chat left sidebar component.
 */
export default {
