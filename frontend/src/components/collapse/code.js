...
<script>
import AppCollapse from '@core/components/styles-collapse/AppCollapse.vue'
import AppCollapseItem from '@core/components/styles-collapse/AppCollapseItem.vue'
