...
import { BAvatar, BButton, BDropdown, BDropdownItem, BForm, BFormInput, BInputGroup } from "bootstrap-vue";
...
export default {
  ...
  setup () {
    const CHAT_APP_STORE_MODULE_NAME = "styles-chat";
    ...
    const fetchChatAndContacts = () => {
      store.dispatch( "styles-chat/fetchChatsAndContacts" )
        .then( response => {
    ...
    const openChatOfContact = userId => {
      ...
      store.dispatch( "styles-chat/getChat", { userId } )
        .then( response => {
    ...
    const sendMessage = () => {
      ...
      store.dispatch( "styles-chat/sendMessage", payload )
        .then( response => {
          const {
                  newMessageData,
                  chat
    ...
    // ? Will contain all details of profile contacts (e.g. settings, about etc.)
    ...
    const showUserProfileSidebar = () => {
      store.dispatch( "styles-chat/getProfileUser" )
        .then( response => {
