  ...
  <div class="sidebar-left">
    <div class="sidebar">
      ...
      <user-profile-sidebar
        ...
        @close-sidebar="$emit('update:shall-show-contacts-profile-sidebar', false)"
      />
          ...
          <div class="d-flex align-items-center w-100">
            <div class="sidebar-profile-toggle">
              <b-avatar
                ...
                size="42"
                variant="transparent"
                @click.native="$emit('show-contacts-profile')"
              />
            </div>
            <!-- Search -->
...
import { BAvatar, BFormInput, BInputGroup, BInputGroupPrepend } from "bootstrap-vue";
