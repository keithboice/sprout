      ...
      <b-col md="4">
        <b-card title="Lists Unstyled">
          <b-card-text>
            ...
            >list-style</code> and left margin on list items (immediate children only).
      ...
      <b-col md="4">
        <b-card>
          ...
          <b-card-text>
            ...
            <code>&lt;ol type="1|a|A|i|I"&gt;</code>, The
      ...
      <b-col md="6">
        <b-card title="Lists icons">
          <b-card-text>
            ...
            <code>.list-style-icons</code> class. You can use any icon from Sprout Admin
            icon types.
          </b-card-text>
...
<script>
import {
  BCard, BCardText, BCardTitle, BCol, BRow,
} from 'bootstrap-vue'
