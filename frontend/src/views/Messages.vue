...
import {
  BAvatar, BDropdown, BDropdownItem, BFormCheckbox, BFormInput, BInputGroup, BInputGroupPrepend, BMedia, BMediaAside, BMediaBody
}                                                from "bootstrap-vue";
import VuePerfectScrollbar                       from "vue-perfect-scrollbar";
import EmailCompose                              from "../components/email/EmailCompose.vue";
import EmailLeftSidebar                          from "../components/email/EmailLeftSidebar.vue";
import emailStoreModule                          from "../components/email/emailStoreModule";
import EmailView                                 from "../components/email/EmailView.vue";
import useEmail                                  from "../components/email/useEmail";
...
export default {
  ...
  setup () {
    const EMAIL_APP_STORE_MODULE_NAME = "styles-email";
    ...
    const fetchEmails = () => {
      store.dispatch( "styles-email/fetchEmails", {
          q:      searchQuery.value,
    ...
    const toggleStarred = email => {
      store.dispatch( "styles-email/updateEmail", {
          emailIds:     [ email.id ],
    ...
    const updateSelectedEmailsLabel = label => {
      store.dispatch( "styles-email/updateEmailLabels", {
          emailIds: selectedEmails.value,
          label
        } )
        .then( () => { fetchEmails(); } )
