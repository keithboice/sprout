<template>
  <b-card-code title="Alert Animation">
    <b-card-text>
      <span>Use the </span> <code>hightFaded</code> <span> directive to enable animation. By default alerts are not animated.</span>
    </b-card-text>
    ...
    <b-card-text class="pt-2 mb-0">
      <span>If you want to show animation even when alert get rendered. You can use </span> <code>appear</code> <span> modifier</span>
    </b-card-text>
