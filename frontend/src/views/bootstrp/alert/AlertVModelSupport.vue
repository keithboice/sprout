<template>
  <b-card-code title="v-model support">
    <b-card-text>
      <span>You can use the </span> <code>v-model</code> <span> directive to create two-way data bindings on the </span> <code>show</code>
      <span> prop as in </span> <code>v-model="showDismissibleAlert"</code> <span> above.</span>
    </b-card-text>
