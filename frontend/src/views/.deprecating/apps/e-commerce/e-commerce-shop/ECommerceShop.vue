<template>
  <div style="height: inherit">
      ...
      <b-row>
        <b-col cols="12">
          <b-input-group class="input-group-merge">
            <b-form-input v-model="filters.q" class="search-product" placeholder="Search Product" />
    ...
    <section :class="itemView">
      <b-card v-for="product in products" :key="product.id" class="ecommerce-card" no-body>
        ...
        <div class="item-options text-center">
          ...
          <b-button class="btn-wishlist" tag="a" variant="light" @click="toggleProductInWishlist(product)">
            <feather-icon :class="{'text-danger': product.isInWishlist}" class="mr-50" icon="HeartIcon" />
            <span>Wishlist</span>
          </b-button>
          <b-button class="btn-cart" tag="a" variant="primary" @click="handleCartActionClick(product)">
    ...
    <section>
      <b-row>
        <b-col cols="12">
          <b-pagination v-model="filters.page" :per-page="filters.perPage" :total-rows="totalProducts" align="center" first-number last-number next-class="next-item" prev-class="prev-item">
            <template #prev-text>
    ...
    <portal to="content-renderer-sidebar-detached-left">
      <shop-left-filter-sidebar :filter-options="filterOptions" :filters="filters" :mq-shall-show-left-sidebar.sync="mqShallShowLeftSidebar" />
    </portal>
  </div>
</template>
...
<style lang="scss">
@import "~@scss/base/pages/app-ecommerce.scss";
</style>
