  ...
  <content-with-sidebar class="blog-wrapper">
    ...
    <b-row class="blog-list-wrapper">
      <b-col v-for="blog in blogList" :key="blog.img" md="6">
        <b-card no-body tag="article">
          <b-link :to="{ name: 'pages-blog-detail', params: { id: blog.id } }">
            <b-img :alt="blog.img.slice(5)" :src="blog.img" class="card-img-top" />
          </b-link>
          <b-card-body>
            <b-card-title>
              <b-link :to="{ name: 'pages-blog-detail', params: { id: blog.id } }" class="blog-title-truncate text-body-heading">
                {{ blog.title }}
              </b-link>
            </b-card-title>
            <b-media no-body>
              <b-media-aside class="mr-50" vertical-align="center">
                <b-avatar :src="blog.avatar" href="javascript:void(0)" size="24" />
              </b-media-aside>
              <b-media-body>
            ...
            <div class="d-flex justify-content-between align-items-center">
              <b-link :to="{ path: `/pages/blog/${blog.id}#blogComment`}">
                <div class="d-flex align-items-center text-body">
                  <feather-icon class="mr-50" icon="MessageSquareIcon" />
      ...
      <b-col cols="12">
        <!-- pagination -->
        <div class="my-2">
          <b-pagination v-model="currentPage" :total-rows="rows" align="center" first-number last-number next-class="next-item" prev-class="prev-item">
            <template #prev-text>
