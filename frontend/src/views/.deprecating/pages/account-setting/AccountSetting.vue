<template>
  <b-tabs content-class="col-12 col-md-9 mt-1 mt-md-0" nav-class="nav-left" nav-wrapper-class="col-md-3 col-12" pills vertical>
    ...
    <b-tab active>
      ...
      <!-- title -->
      <template #title>
        <feather-icon class="mr-50" icon="UserIcon" size="18" />
    ...
    <b-tab>
      ...
      <!-- title -->
      <template #title>
        <feather-icon class="mr-50" icon="LockIcon" size="18" />
    ...
    <b-tab>
      ...
      <!-- title -->
      <template #title>
        <feather-icon class="mr-50" icon="InfoIcon" size="18" />
    ...
    <b-tab>
      ...
      <!-- title -->
      <template #title>
        <feather-icon class="mr-50" icon="LinkIcon" size="18" />
    ...
    <b-tab>
      ...
      <!-- title -->
      <template #title>
        <feather-icon class="mr-50" icon="BellIcon" size="18" />
