          ...
          <b-form class="auth-login-form mt-2" @submit.prevent>
            ...
            <b-form-group label="Email" label-for="email">
              <validation-provider #default="{ errors }" name="Email" rules="required|email">
                <b-form-input id="email" v-model="userEmail" :state="errors.length > 0 ? false:null" autofocus name="login-email" placeholder="john@example.com" />
            ...
            <b-form-group>
              ...
              <validation-provider #default="{ errors }" name="Password" rules="required">
                <b-input-group :class="errors.length > 0 ? 'is-invalid':null" class="input-group-merge">
                  <b-form-input id="password" v-model="password" :state="errors.length > 0 ? false:null" :type="passwordFieldType" class="form-control-merge" name="login-password" placeholder="Password" />
