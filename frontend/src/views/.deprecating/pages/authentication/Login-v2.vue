        ...
        <b-col class="px-xl-2 mx-auto" lg="12" md="6" sm="8">
          ...
          <validation-observer ref="loginValidation">
            <b-form class="auth-login-form mt-2" @submit.prevent>
              ...
              <b-form-group>
                ...
                <validation-provider #default="{ errors }" name="Password" rules="required">
                  <b-input-group :class="errors.length > 0 ? 'is-invalid':null" class="input-group-merge">
                    <b-form-input id="login-password" v-model="password" :state="errors.length > 0 ? false:null" :type="passwordFieldType" class="form-control-merge" name="login-password" placeholder="············" />
              ...
              <!-- submit buttons -->
              <b-button block type="submit" variant="primary" @click="validationForm">
                Sign in
              </b-button>
            </b-form>
          </validation-observer>
...
export default {
  ...
  data () {
    return {
      ...
      password:  "",
      userEmail: "",
      sideImg:   require( "@images/pages/login-v2.svg" ), // validation rulesimport store from '@/store/index'
      required,
      email
    }
  },
