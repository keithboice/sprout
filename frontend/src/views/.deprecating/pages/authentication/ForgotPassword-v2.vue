    ...
    <b-row class="auth-inner m-0">
      ...
      <b-col class="d-none d-lg-flex align-items-center p-5" lg="8">
        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
          <b-img :src="imgUrl" alt="Forgot password V2" fluid />
        </div>
      </b-col>
      <!-- /Left Text-->
...
export default {
  ...
  data () {
    return {
      userEmail: "",
      sideImg:   require( "@images/pages/forgot-password-v2.svg" ), // validation
      required,
      email
    }
  },
  computed: {
    imgUrl () {
      if ( store.state.chat.layout.skin === "dark" ) {
        ...
        this.sideImg = require( "@images/pages/forgot-password-v2-dark.svg" )
        return this.sideImg
      }
      return this.sideImg
    }
