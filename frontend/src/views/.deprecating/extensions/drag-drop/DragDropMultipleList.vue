<template>
  <b-card-code title="Multiple Lists">
    <b-card-text>
      <span>Drag and drop items of more than one list. Add same </span> <code>group</code> <span> to </span> <code>group</code> <span> prop.</span>
    </b-card-text>
    ...
    <b-row>
      ...
      <b-col md="6">
        ...
        <!-- draggable -->
        <draggable :list="list1" class="list-group list-group-flush cursor-move" group="people" tag="ul">
      ...
      <!-- people group 2 -->
      <b-col class="mt-sm-2 mt-md-0" md="6">
        <h6 class="text-primary font-weight-bold mb-2">
          People Group 2 </h6>
        
        <!-- draggable -->
        <draggable :list="list2" class="list-group list-group-flush cursor-move" group="people" tag="ul">
