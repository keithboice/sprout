<template>
  <b-card-code title="Contained Slider">
    <b-card-text>
      <span>When </span> <code>contained</code> <span> is set to </span> <code>true</code> <span>, the edge of the </span> <code>dot</code>
    ...
    <div class="wrap">
      ...
      <vue-slider :contained="true" :direction="direction" />
