<template>
  <b-card-code title="Parallax">
    <swiper :dir="$store.state.chat.isRTL ? 'rtl' : 'ltr'" :options="swiperOptions" class="swiper-parallax">
      <div slot="parallax-bg" class="parallax-bg" data-swiper-parallax="-23%">
        <b-img :src="require('@images/banner/parallax-4.jpg')" alt="banner" class="img-fluid" />
      </div>
