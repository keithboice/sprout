<template>
  <b-card-code title="Search Tree">
    ...
    <!-- tree -->
    <v-tree ref="tree" :can-delete-root="true" :data="treeData" :draggable="true" :halfcheck="true" :multiple="true" :tpl="tpl" />
  ...
  methods: {
    ...
    tpl ( ...args ) {
      ...
      return <span>
        ...
        <button class="btn-delete text-danger border-0 cursor-pointer" onClick={ () => this.$refs.tree.delNode( node, parent,
                                                                                                                index
        ) }>delete</button>
      </span>
    },
