<template>
  <b-card-code title="Close On Click">
    <b-card-text>
      <code>closeOnClick</code> <span> is set to </span> <code>false</code>
    ...
    <!-- button -->
    <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="outline-primary" @contextmenu.prevent="$refs.menuProp.open">
...
export default {
  components: {
    ...
    BCardText,
    BCardCode,
    VueContext, // eslint-disable-next-line vue/no-unused-components
