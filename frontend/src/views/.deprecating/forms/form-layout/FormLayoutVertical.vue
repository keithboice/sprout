      ...
      <b-row>
        ...
        <b-col cols="12">
          <b-form-group label="Email" label-for="v-email">
            <b-form-input id="v-email" placeholder="Email" type="email" />
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12">
          <b-form-group label="Mobile" label-for="v-mobile">
            <b-form-input id="v-mobile" placeholder="Mobile" type="number" />
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12">
          <b-form-group label="Password" label-for="v-password">
            <b-form-input id="v-password" placeholder="Password" type="password" />
          </b-form-group>
        </b-col>
