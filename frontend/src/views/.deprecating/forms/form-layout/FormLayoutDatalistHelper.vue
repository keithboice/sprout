      ...
      <b-row>
        ...
        <b-col cols="12">
          <b-form-group label="Email" label-for="d-email">
            <b-form-input id="d-email" placeholder="Email" type="email" />
        ...
        <b-col cols="12">
          <b-form-group label="Password" label-for="d-password">
            <b-form-input id="d-password" placeholder="Password" type="password" />
...
import { BRow, BCol, BFormGroup, BFormInput, BFormCheckbox, BForm, BButton, BFormText, BFormDatalist } from "bootstrap-vue"
