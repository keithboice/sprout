<template>
  <b-card-code title="File Input Basic">
    ...
    <div>
      ...
      <!-- Styled -->
      <b-form-file v-model="file" drop-placeholder="Drop file here..." placeholder="Choose a file or drop it here..." />
      ...
      <b-card-text>
        <span>You can have </span> <code>&lt;b-form-file&gt;</code> <span> render a browser native file input by setting the </span>
        <code>plain</code> <span> prop.</span>
      </b-card-text>
