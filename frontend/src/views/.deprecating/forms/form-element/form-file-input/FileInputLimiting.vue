<template>
  <b-card-code title="Limiting to certain file types">
    <b-card-text>
      <span>You can limit the file types by setting the </span> <code>accept</code> <span>
    ...
    <label class="mt-1" for="IANA">Accept specific image formats by IANA type</label>
    <b-form-file id="IANA" accept="image/jpeg, image/png, image/gif" />
    
    <!-- Accept specific image formats by extension -->
    <label class="mt-1" for="extension">Accept specific image formats by extension</label>
