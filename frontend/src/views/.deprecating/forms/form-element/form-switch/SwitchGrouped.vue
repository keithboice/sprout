<template>
  <b-card-code title="Grouped switch ">
    <b-card-text>
      <span>Render groups of checkboxes with the look of a switches by setting the prop switches on </span> <code>&lt;b-form-checkbox-group&gt;</code>.
    </b-card-text>
    
    <div>
      <b-form-group label="Inline switch style checkboxes">
        <b-form-checkbox-group v-model="selected" :options="options" class="demo-inline-spacing" switches />
      </b-form-group>
