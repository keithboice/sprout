<template>
  <b-card-code title="Icons">
    <b-card-text class="mb-0">
      <span>Use class </span> <code>.switch-icon-left & .switch-icon-right</code> <span> inside of</span> <code>&lt;b-form-checkbox switch&gt;</code>
    ...
    <div class="demo-inline-spacing">
      ...
      <div>
        ...
        <b-form-checkbox checked="true" class="custom-control-primary" name="check-button" switch>
          ...
          </span> <span class="switch-icon-right">
