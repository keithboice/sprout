<template>
  <b-card-code title="Disabled and readonly states">
    <b-card-text>
      <span>Setting the </span> <code>disabled</code> <span> prop will remove all interactivity of the </span> <code>&lt;b-form-timepicker&gt;</code>
      <span> component.</span>
    </b-card-text>
    
    <b-card-text>
      <span>Setting the </span> <code>readonly</code> <span>
        prop will disable selecting a time, but will keep the component interactive, allowing for tabbing between
        spinbuttons. The
      </span> <code>v-model</code> <span> will not be updated in the readonly state.</span>
    </b-card-text>
