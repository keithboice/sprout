<template>
  <b-card-code title="Internationalization">
    <b-card-text>
      <span>By default </span> <code>&lt;b-form-timepicker&gt;</code>
      <span> will use the browser's default locale, but you can specify the locale (or locales) to use via the </span> <code>locale</code> <span>
    ...
    <b-row>
      ...
      <b-col md="6">
        <b-form-timepicker v-model="value" v-bind="labels[locale] || {}" :locale="locale" show-seconds @context="onContext" />
      </b-col>
      <b-col>
        <b-card-text>
          Value: <b>'{{ value }}'</b>
