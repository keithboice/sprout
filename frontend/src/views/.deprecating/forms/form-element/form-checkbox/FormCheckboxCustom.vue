<template>
  <b-card-code title="Custom Checkboxes">
    <b-card-text class="mb-0">
      <span>For cross browser consistency, </span> <code>&lt;b-form-checkbox-group&gt;</code> <span> and </span> <code>&lt;b-form-checkbox&gt;</code>
      <span>
    ...
    <div class="demo-inline-spacing">
      ...
      <b-form-checkbox v-model="selected" disabled value="C">
        Checked disabled
      </b-form-checkbox>
      <b-form-checkbox v-model="selected" disabled value="D">
        Unchecked disabled
      </b-form-checkbox>
    </div>
