<template>
  <b-card-code title="Standard (single) select">
    <b-card-text>
      <span>In non </span> <code>multiple</code> <span> mode, </span> <code>&lt;b-form-select&gt;</code> <span> returns the a single </span>
      <code>value</code> <span> of the currently selected option. </span>
    </b-card-text>
