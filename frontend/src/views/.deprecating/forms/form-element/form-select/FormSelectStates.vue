<template>
  <b-card-code title="Contextual states">
    <b-card-text>
      <span>Bootstrap includes validation styles for </span> <code>valid</code> <span> and </span> <code>invalid</code>
      <span> states on most form controls.</span>
    </b-card-text>
    
    <b-card-text>
      <span>To apply one of the contextual state icons on </span> <code>&lt;b-form-select&gt;</code> <span>, set the </span> <code>state</code>
      <span> prop to </span> <code>false</code> <span> (for invalid), </span> <code>true</code> <span> (for valid), or </span> <code>null</code>
