<template>
  <b-card-code title="Select sizing (displayed rows)">
    <b-card-text>
      <span>You can use the </span> <code>select-size</code>
      <span> prop to switch the custom select into a select list-box, rather than a dropdown. Set the </span> <code>select-size</code>
