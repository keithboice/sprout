<template>
  <b-card-code title="Styling Options">
    ...
    <div>
      ...
      <b-form-tags v-model="value" class="mb-2" input-id="tags-pills" placeholder="Enter new tags separated by space" separator=" " size="lg" tag-pills tag-variant="primary" />
