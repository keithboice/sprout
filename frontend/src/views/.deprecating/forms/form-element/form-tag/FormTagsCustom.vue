<template>
  <b-card-code title="Using custom form components">
    <b-card-text>
      The scope contains attributes and event handlers that can be directly bound to most custom inputs or select components.
    </b-card-text>
    ...
    <div>
      <b-form-group label="Tagged input using select">
        ...
        <b-form-tags v-model="value" add-on-change no-outer-focus size="lg">
