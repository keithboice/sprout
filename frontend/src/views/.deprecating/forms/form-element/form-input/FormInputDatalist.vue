<template>
  <b-card-code title="Datalist support">
    <b-card-text>
      <span>Datalists are a native HTML tag </span> <code>&lt;datalist&gt;</code> <span> that contains a list of </span> <code>&lt;option&gt;</code>
      <span>
        tags. By assigning an ID to the datalist tag, the list can be references from a text input by adding a
      </span> <code>list</code> <span> attribute.</span>
    </b-card-text>
