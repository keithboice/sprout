<template>
  <b-card-code title="Locale">
    <b-card-text>
      <span>By default </span> <code>&lt;b-form-spinbutton&gt;</code> <span>
    ...
    <div>
      ...
      <label class="mt-2" for="sb-local">Spin button with locale</label>
      <b-form-spinbutton id="sb-locale" v-model="value" :locale="locale" max="10" min="0" step="0.125" />
