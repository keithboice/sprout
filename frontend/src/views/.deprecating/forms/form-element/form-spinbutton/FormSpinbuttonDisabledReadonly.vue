<template>
  <b-card-code title="Disabled and readonly states">
    <b-card-text>
      <span>Setting the prop </span> <code>disabled</code> <span> places the component in a disabled, non-interactive state. The </span>
    ...
    <b-row>
      ...
      <b-col class="mb-2" md="6">
        <label class="" for="sb-readonly">Readonly spin button</label>
