        ...
        <b-row>
          ...
          <b-col cols="12">
            <b-form-group label="Password" label-for="a-password">
              <validation-provider #default="{ errors }" name="Password" rules="required|min:8|password" vid="Password">
                <b-form-input id="a-password" v-model="username" :state="errors.length > 0 ? false:null" placeholder="Password" type="password" />
          ...
          <b-col cols="12">
            <b-form-group label="Confirm Password" label-for="ac-password">
              <validation-provider #default="{ errors }" name="Confirm Password" rules="required|confirmed:Password">
                ...
                <b-form-input id="ac-password" v-model="passValue" :state="errors.length > 0 ? false:null" placeholder="Confirm Password" type="password" />
                <small class="text-danger">{{ errors[ 0 ] }}</small>
              </validation-provider>
            </b-form-group>
          </b-col>
