<template>
  <b-card v-if="data" no-body>
    ...
    <b-card-header class="pb-0">
      ...
      <b-dropdown class="chart-dropdown" no-caret right size="sm" text="Last 7 Days" toggle-class="p-50" variant="transparent">
    ...
    <b-card-body>
      <b-row>
        <b-col class="d-flex flex-column flex-wrap text-center" sm="2">
        ...
        <!-- chart -->
        <b-col class="d-flex justify-content-center" sm="10">
          
          <!-- apex chart -->
          <vue-apex-charts :options="supportTrackerRadialBar.chartOptions" :series="data.supportTrackerRadialBar.series" height="270" type="radialBar" />
        </b-col>
        <!--/ chart -->
      </b-row>
