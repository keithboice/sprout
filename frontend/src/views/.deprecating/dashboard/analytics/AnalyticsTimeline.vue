      ...
      <app-timeline>
        <app-timeline-item variant="primary">
          ...
          <b-media no-body>
            <b-media-aside class="mr-1">
              <b-img :alt="data.step1.fileName " :src="data.step1.img" height="23" />
            </b-media-aside>
            <b-media-body class="my-auto">
              <h6 class="media-body mb-0">
                {{ data.step1.fileName }} </h6>
            </b-media-body>
          </b-media>
        </app-timeline-item>
        ...
        <app-timeline-item variant="warning">
          ...
          <b-media no-body>
            ...
            <b-media-body class="my-auto">
              <h6 class="mb-0">
                {{ data.step2.avatarName }} </h6>
              <p class="mb-0">
                {{ data.step2.occupation }} </p>
            </b-media-body>
          </b-media>
        </app-timeline-item>
        ...
        <app-timeline-item variant="info">
          ...
          <b-avatar-group size="35px">
            <b-avatar v-for="avatar in data.step3.avatars" :key="avatar.userImg" v-b-tooltip.hover.top="'Tooltip!'" :src="avatar.userImg" class="pull-up" />
          </b-avatar-group>
        </app-timeline-item>
        
        <app-timeline-item :subtitle="data.step4.subtitle" :time="data.step4.duration" :title="data.step4.title" variant="danger" />
      </app-timeline>
      <!--/ timeline -->
    </b-card-body>
  </b-card>
...
<script>
import { BCard, BCardBody, BCardHeader, BCardTitle, BImg, BMedia, BMediaBody, BMediaAside, BAvatar, BAvatarGroup, VBTooltip } from "bootstrap-vue"
import AppTimeline
                                                                                                                              from "@core/components/app-timeline/AppTimeline.vue"
