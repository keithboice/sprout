  ...
  <b-card v-if="data" no-body>
    ...
    <b-card-body>
      <div class="d-inline-flex align-items-center mr-2">
        <feather-icon class="text-primary mr-50" icon="CircleIcon" />
        <span>Sales</span>
      </div>
      <div class="d-inline-flex align-items-center">
        <feather-icon class="text-info mr-50" icon="CircleIcon" />
        <span>Visits</span>
      </div>
      
      <!-- apex chart -->
      <vue-apex-charts :options="statisticsRadar.chartOptions" :series="data.series" height="275" type="radar" />
    </b-card-body>
  </b-card>
</template>
