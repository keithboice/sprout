<template>
  <section id="feather-icons">
    ...
    <div id="icons-container" class="d-flex flex-wrap">
      <b-card v-for="icon in filterIcons" :key="icon" v-b-tooltip.hover.top="icon" class="icon-card cursor-pointer text-center mb-2 mx-50" @click="copyIconName(icon)">
...
export default {
  components: {
    ...
    BInputGroup,
    BCardText,
    BInputGroupPrepend, // eslint-disable-next-line vue/no-unused-components
  ...
  computed: {
    filterIcons () {
      ...
      return this.icons.filter( item => item.toLowerCase()
        .includes( seachQueryIcon ) )
    }
  },
  setup () {
