<template>
  <b-card-code title="SSR">
    ...
    <div class="custom-search d-flex justify-content-end">
      <b-form-group>
        <div class="d-flex align-items-center">
          ...
          <b-form-input v-model="searchTerm" class="d-inline-block" placeholder="Search" type="text" @input="handleSearch" />
        </div>
      </b-form-group>
    </div>
    ...
    <vue-good-table :columns="columns" :pagination-options="{
      ...
      }" mode="remote" @on-sort-change="onSortChange">
      ...
      <template slot="pagination-bottom" slot-scope="props">
        <div class="d-flex justify-content-between flex-wrap">
          ...
          <!-- pagination -->
          <div>
            <b-pagination :per-page="pageLength" :total-rows="props.total" :value="1" align="right" class="mt-1 mb-0" first-number last-number next-class="next-item" prev-class="prev-item" @change="handleChangePage">
              <template #prev-text>
