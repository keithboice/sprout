<template>
  <b-card-code no-body title="Sticky columns and headers">
    <b-card-body>
    ...
    <!-- table -->
    <b-table :fields="fields" :items="items" :no-border-collapse="noCollapse" :sticky-header="stickyHeader" class="mb-0" responsive>
      ...
      <template #cell(avatar)="data">
        <b-avatar :src="data.value" class="mr-1" />
      </template>
