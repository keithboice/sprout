...
const data = {
  pricing: {
    ...
    enterprisePlan: {
      ...
      planBenefits: [
        "PayPal payments", "Logic Jumps", "File upload with 5GB storage", "Custom domain support", "Stripe integration"
      ],
      popular:      false
    },
    qandA:          [
      {
        ...
        question: "Am I allowed to modify the item that I tryd?",
...
/* eslint-disable global-require */
mock.onGet( "/pricing/data" )
  .reply( () => [ 200, data.pricing ] )
