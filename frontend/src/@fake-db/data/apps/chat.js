...
// ------------------------------------------------
mock.onGet( "/apps/chat/chats-and-contacts" )
  .reply( () => {
...
// ------------------------------------------------
mock.onGet( "/apps/chat/users/profile-contacts" )
  .reply( () => [ 200, data.profileUser ] );

// ------------------------------------------------
// GET: Return Single Chat
// ------------------------------------------------
mock.onGet( /\/apps\/chat\/chats\/\d+/ )
  .reply( config => {
...
// ------------------------------------------------
mock.onPost( /\/apps\/chat\/chats\/\d+/ )
  .reply( config => {
    // Get contacts id from URL
    ...
    // If there's new chat for contacts create one
    let isNewChat = false;
