...
// GET: Return Users
// ------------------------------------------------
mock.onGet( "/apps/contacts/users" )
  .reply( config => {
    ...
    const filteredData = data.users.filter( user => /* eslint-disable operator-linebreak, implicit-arrow-linebreak */
                                              (
                                                user.username.toLowerCase()
                                                  .includes( queryLowered ) || user.fullName.toLowerCase()
...
// ------------------------------------------------
mock.onPost( "/apps/contacts/users" )
  .reply( config => {
