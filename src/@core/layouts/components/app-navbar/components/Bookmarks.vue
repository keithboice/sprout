...
import useAutoSuggest
  from '@core/components/app-auto-suggest/useAutoSuggest'
import { ref, watch } from '@vue/composition-api'
import {
  BDropdownItem, BFormInput, BNavbarNav, BNavItem, BNavItemDropdown, BTooltip,
} from 'bootstrap-vue'
import VuePerfectScrollbar from 'vue-perfect-scrollbar'
import searchAndBookmarkData
  from '../search-and-bookmark-data'
