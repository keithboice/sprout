...
import { BButton, BCardText, BSpinner } from "bootstrap-vue";
...
export default {
  components: {
    BCardCode,
    BButton,
    BCardText, // eslint-disable-next-line
    BSpinner
  },
  directives: {
    Ripple
  ...
  methods: {
    popToast () {
      ...
      const vNodesTitle = h( "div", { class: [ "d-flex", "flex-grow-1", "align-items-baseline", "mr-2" ] }, [
        h( "strong", { class: "mr-2" }, "The Title" ), h( "small", { class: "ml-auto font-italics" }, "5 minutes ago" )
      ] );
