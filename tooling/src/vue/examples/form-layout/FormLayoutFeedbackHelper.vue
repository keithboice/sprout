...
import {
  BButton, BCol, BForm, BFormCheckbox, BFormDatalist, BFormGroup, BFormInput, BFormInvalidFeedback, BFormText, BFormValidFeedback, BInputGroup,
  BInputGroupPrepend, BRow
}                             from "bootstrap-vue";
